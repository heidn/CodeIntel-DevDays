...
**Generated:** 2026-05-14 17:25:31 UTC  
...
```text
#file:2026-05-14-find-bugs-9f37af94.md
```
...
<finding>{
  ...
  "description": "When prompt is null (legal per the method signature at line 59), line 61 calls _executor.InferAsync(prompt, inferenceParams, ct) and throws NullReferenceException before any validation runs.",
